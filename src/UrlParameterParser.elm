-- adapted from https://github.com/jessitron/elm-param-parsing
module UrlParameterParser exposing (ParseResult, parseQueryString)
...
{-|
 ...
 -}
parseQueryString : String -> ParseResult
parseQueryString startsWithQuestionMarkThenParams =
